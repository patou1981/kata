...
class TennisTest {
    ...
    void given_sequence_point_A_should_print_the_proper_score(String sequence, List<String> message) {
        ...
        Logger logger = loggerContext.getLogger(Tennis.class);
    ...
    void given_who_wins_points_should_return_the_winner(String sequence, Player expectedWinner) {
        Tennis match = new Tennis();

        // When
        Optional<Player> winner = match.play(sequence);
